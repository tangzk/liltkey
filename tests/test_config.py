...
class ConfigTests(unittest.TestCase):
    ...
    def test_streaming_refinement_defaults_on_and_remains_strictly_boolean(self):
        self.assertTrue(Config().streaming_refine)
        self.assertTrue(self.load('').streaming_refine)
